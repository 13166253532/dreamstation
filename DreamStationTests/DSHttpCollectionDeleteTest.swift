//
//  DSHttpCollectionDeleteTest.swift
//  DreamStation
//
...
class DSHttpCollectionDeleteTest: XCTestCase {
    ...
    func testHttpCollectionDelete() {
        ...
        dict[kHttpParamKey_Collection_collectionId]="001"
        ...
        let r = cmd.result as! DSHttpCollectionDeleteResult
        if r.isOk() {
